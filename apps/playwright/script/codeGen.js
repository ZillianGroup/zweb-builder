...
childProcess.execSync(`pnpm playwright codegen  ${process.env.ZWEB_BUILDER_URL}/${process.env.ZWEB_CLOUD_TEAM_IDENTITY}/dashboard/apps --load-storage=.auth/user.json --ignore-https-errors`)