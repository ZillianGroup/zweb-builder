...
1. Account information within ZWEB: user ID, username, and email address.
2. Team information within ZWEB: Team Identifier, team name, etc.
...
4. Your usage data within ZWEB, such as pages accessed and features clicked on ZWEB.
...
8. We may also use Personal Information you provide to send you email marketing about ZWEB products and services, invite you to participate in events or surveys, or otherwise communicate with you for marketing purposes. We allow you to opt-out from receiving marketing communications from us as described in the "Your Choices" section below.
...
You are responsible for maintaining the secrecy of your unique password and account information, and for controlling access to your email communications from ZWEB. Your privacy settings may also be affected by changes to the functionality of third-party sites and services that you add to the ZWEB Service, such as single sign on. ZWEB is not responsible for the functionality or security measures of any third party. Upon becoming aware of a breach of your Personal Information, we will notify you as quickly as we can and will provide timely information relating to the breach as it becomes known in accordance with any applicable laws and regulations or as is reasonably requested by you.
...
## Who at ZWEB may access your Personal Information?
...
1. We may share your Personal Information with other companies owned by or under common ownership as ZWEB, which also includes our subsidiaries (i.e., any organization we own or control).
...
Residents of the European Economic Area and Switzerland: The Data Protection Officer can be contacted at business@zilliangroup.com

## Contacting Us

If you would like to submit a data rights request (also known as a data subject access request), please email business@zilliangroup.com。

If you have any other questions, comments, or concerns about this privacy policy, please contact us via email: business@zilliangroup.com.
